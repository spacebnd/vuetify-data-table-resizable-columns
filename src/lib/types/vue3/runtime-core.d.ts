...
export declare interface FunctionalComponent<P = {}, E extends EmitsOptions = {}>
...
declare type InferDefault<P, T> = T extends null | number | string | boolean | symbol | Function
  ? T
  : (props: P) => T
...
declare type UnwrapMixinsType<T, Type extends OptionTypesKeys> = T extends OptionTypesType
  ? T[Type]
  : never
